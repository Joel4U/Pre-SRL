...
class Config:
    def __init__(self, args) -> None:
        ...
        self.train_file = "data/" + self.dataset + "/train.jsonlines"
        self.dev_file = "data/" + self.dataset + "/dev.jsonlines"
        self.test_file = "data/" + self.dataset + "/test.jsonlines"
        self.label_file = "data/" + self.dataset + "/labels.json"
        if '05' in args.dataset:
            self.test_file_brown = "data/" + self.dataset + "/test_brown.jsonlines"
        # Training hyperparameter
        self.optimizer = args.optimizer.lower()
        self.pretr_lr = args.pretr_lr
        self.other_lr = args.other_lr
        self.pretr_frozen = args.pretr_frozen
