...
class TransformerEncoder(nn.Module):
    def __init__(self, d_model, num_layers, n_head, feedforward_dim, dropout, output_dim, after_norm=True, attn_type='adatrans',
        ...
        self.linear_out = nn.Linear(in_features=d_model, out_features=output_dim)
